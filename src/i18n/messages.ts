...
const en: Messages = {
  ...
  saveLoop: 'Save loop',
  openStill: 'Open still',
  shareOnX: 'Share on X',
  facebook: 'Facebook',
  whatsapp: 'WhatsApp',
  scanGrove: 'Scan grove',
  scanning: 'Scanning…',
  holdOverhead: 'Hold the tree from above, then scan.',
  enterPassword: 'Enter the password, then scan.',
  wrongPassword: 'Wrong password.',
  importStillNote: 'Import a still, then scan the grove to read it.',
  ...
  errors: {
    ...
    'This image is not a grove still.': 'This image is not a grove still.',
...
const zhCN: Messages = {
  ...
  wrongPassword: '密码错误。',
  importStillNote: '导入静态图，再识别树林即可读取。',
  ...
  errors: {
    ...
    'This image is not a grove still.': '这张图片不是 grove 静态图。',
...
const zhTW: Messages = {
  ...
  wrongPassword: '密碼錯誤。',
  importStillNote: '匯入靜態圖，再辨識樹林即可讀取。',
  ...
  errors: {
    ...
    'This image is not a grove still.': '這張圖片不是 grove 靜態圖。',
...
const ja: Messages = {
  ...
  importStillNote: '静止画を読み込み、木立を読み取ってください。',
  ...
  errors: {
    ...
    'This image is not a grove still.': 'この画像は grove の静止画ではありません。',
...
const ru: Messages = {
  ...
  errors: {
    ...
    'This image is not a grove still.': 'Это изображение — не кадр grove.',
...
const fr: Messages = {
  ...
  errors: {
    ...
    'This image is not a grove still.': 'Cette image n\u2019est pas une image grove.',
